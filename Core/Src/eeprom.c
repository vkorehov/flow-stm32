...
static uint32_t varIdList[VAR_NUM] = {PARAM_1, PARAM_2, PARAM_3, PARAM_4, PARAM_5, PARAM_6, PARAM_7, PARAM_8, PARAM_9, PARAM_10, PARAM_11};

void EEPROM_DumpState(char* buff, int len) {
    uint32_t param1 = 0xdeadbeef;
    uint32_t param2 = 0xdeadbeef;
    uint32_t param11 = 0xdeadbeef;    
    EEPROM_Read(PARAM_1, &param1);
    EEPROM_Read(PARAM_2, &param2);
    EEPROM_Read(PARAM_11, &param11);    
    snprintf(buff, len,
        "EEPROM param1=0x%08lX param2=0x%08lX param11=0x%08lX",
        param1,
        param2,
        param11
    );
